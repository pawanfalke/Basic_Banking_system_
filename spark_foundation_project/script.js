function sendMoney(){
    ...
    if(enterAmount>enterSAmount){
        ...
        alert(`Successful Transaction !! Rs ${enterAmount} is sent to ${enterName}@gmail.com.`)
        //transaction history
        var createPTag=document.createElement("li");
        var textNode=document.createTextNode(`Rs ${enterAmount} is sent from the sender with Email-id ${enterSname}@gmail.com to recepient with Email-id ${enterName}@gmail.com on ${Date()}.`)
